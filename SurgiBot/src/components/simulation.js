...
import RAPIER from '../util/rapier3d-compat.js';
import { OrbitControls } from 'three/addons/controls/OrbitControls.js';
import { TransformControls } from 'three/addons/controls/TransformControls.js';
import { Robot } from '../util/robot.js'
import * as utils from '../util/rapier_utils.js'
...
async function init() {
    ...
    container = document.querySelector('.simulation');
    renderer = new THREE.WebGLRenderer({antialias: true});
    renderer.setPixelRatio(window.devicePixelRatio);

    // let w = window.visualViewport.width; // rendered window width
    // let h = window.visualViewport.height; // rendered window height
